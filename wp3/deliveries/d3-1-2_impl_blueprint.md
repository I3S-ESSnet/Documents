...
This document and "infrastructre as code" describes how the I3S-project has containerized and implemented three of the applications as shared statistical services on two service providers of cloud platforms. The [IS2 (ARC)](https://ec.europa.eu/eurostat/cros/content/i3s-d321-package-container-service-1_en) example is established on a Google Cloud Platform (GCP) instance, [PXWeb](https://ec.europa.eu/eurostat/cros/content/i3s-d322-package-container-service-2_en) is established on a Microsoft Azure instance, and the [Relais](https://ec.europa.eu/eurostat/cros/content/i3s-d323-package-container-service-3_en) is containerized.
