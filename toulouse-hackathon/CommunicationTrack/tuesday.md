...
Proposition for a flyer template (with propositions of questions in order to help filling the different parts):
  ...
  * Conditions of using
  * Documentation and additional resources, link to the Catalogue (What is the channel to obtain the service ? Is a manual available ? Is there any help desk ? What is the level of technical support ? Is there any support for day to day operation ?)
  * Future development
  * License
